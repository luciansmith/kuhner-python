...
#expands_core = "expands_full_results"
...
#    print str(patient) + "\t" + str(numsamples) + "\t" + str(len(allpops)) + "\t" + str(avgdiseq) + "\t" + str(numpy.average(shuffledaverages)) + "\t" + str(numpy.std(shuffledaverages))
    perpatient.write(patient + "\t" + str(len(patientdata[patient])) + "\t" + str(numpops) + "\t" + str(numsegs) + "\t" + str(foundfour) + "\t" + str(notfour) + "\t" + str(numlteqFF/numtot) + "\t" + str(numpy.average(totfoundfour)) + "\t" + str(numpy.std(totfoundfour)) + "\n")
    print patient + "\t" + str(len(patientdata[patient])) + "\t" + str(numpops) + "\t" + str(numsegs) + "\t" + str(foundfour) + "\t" + str(notfour) + "\t" + str(numlteqFF/numtot) + "\t" + str(numpy.average(totfoundfour)) + "\t" + str(numpy.std(totfoundfour))
    #print allpops
#    probones = []
#    numsegs = len(allpops)
#    numpops = len(allpops[0])
